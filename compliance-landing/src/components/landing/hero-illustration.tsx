 ...
 * "Проверено ИИ" chip. Purely illustrative → aria-hidden. Cards stagger in on
 * load, skeleton lines shimmer (as if analyzing), and the badge gently floats.
 */
  ...
  return (
    <div className="mx-auto w-full max-w-xl">
      <div className="relative" aria-hidden="true">
        ...
        {/* briefcase badge */}
        <div className="animate-hero-badge absolute -right-2 top-3 z-20 grid size-12 place-items-center rounded-full bg-gradient-to-br from-[#7c7ae0] to-[#a78bfa] text-white shadow-lg shadow-[#7c7ae0]/30">
