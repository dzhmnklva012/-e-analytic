    ...
    <section id="tools" className="overflow-hidden py-16 sm:py-20 lg:py-24">
      <Container className="flex flex-col items-center gap-12">
        ...
        <Reveal dir="scale" className="relative mx-auto aspect-square w-full max-w-2xl">
          ...
          {/* central engine */}
          <div className="absolute left-1/2 top-1/2 grid size-16 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-gradient-to-br from-[#068dff] to-[#60a5fa] text-white shadow-2xl shadow-primary/40 ring-8 ring-background animate-soft-pulse">
