...
const nodes: OrbitNodeData[] = [
  {
    ...
    x: 33,
    y: 17,
    gradient: "bg-gradient-to-br from-[#0070eb] to-[#4aa3ff]",
    glow: "shadow-[#0070eb]/40",
    ...
    <div className="relative mx-auto hidden h-[34rem] w-full max-w-[40rem] lg:block">
      ...
      >
        <div className="relative grid place-items-center">
          ...
          <span className="relative grid size-24 place-items-center rounded-full bg-gradient-to-br from-[#0070eb] to-[#5b8def] text-white shadow-2xl shadow-primary/40 ring-8 ring-card">
